...
Vous trouvez aussi ce starter dans le repository de ce cours : [ui-library-starter](https://github.com/e-vinci/cae-theory/tree/main/ui-library-starter).
...
Si nécessaire, vous pouvez trouver le code associé à ce tutoriel ici : [ui-library](https://github.com/e-vinci/cae-theory/tree/main/ui-library).