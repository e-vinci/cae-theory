...
Pour ce tutoriel, veuillez créer un nouveau projet nommé `api` sur base d'un copier/coller du dossier `api-starter` ici : [api-starter](https://github.com/e-vinci/cae-theory/tree/main/api-starter).
...
Si nécessaire, vous pouvez trouver le code associé aux tutoriels `api` ic : [api](https://github.com/e-vinci/cae-theory/tree/main/api).
