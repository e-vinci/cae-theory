...
- **Planner** : peut voir les projets, mais ne peut pas les modifier ; peut créer des issues mais pas des *merge requests* ; peut complétemnt gérer des épics ; ne peut pas pusher du code.
...
Si nécessaire, vous pouvez trouver le code associé à l'intégration continue ici : [api-ci](https://github.com/e-vinci/cae-theory/tree/main/api-ci).